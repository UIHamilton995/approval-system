...
//     if (numericAmount <= 500000) return "Dr. Temitope Falaiye";
...
//         setToastMessage("Error fetching provider list.");
//         setShowSuccessToast(true);
//       } finally {
...
//         setToastMessage("Error fetching company list.");
//         setShowSuccessToast(true);
//       }
//     };
//     fetchAllCompanies();
...
//   useEffect(() => {
//     const fetchEnrollees = async (groupId) => {
//       if (!groupId) {
//         setAllEnrollees([]);
...
//         );
//         if (!response.ok) throw new Error('Network response was not ok for enrollees');
//         const data = await response.json();
//         setAllEnrollees(data.result_overview || []);
//         setFilteredEnrollees(data.result_overview || []);
//       } catch (error) {
//         console.error("Error fetching enrollees:", error);
//         setToastMessage("Error fetching enrollee list.");
//         setShowSuccessToast(true);
//         setAllEnrollees([]);
//         setFilteredEnrollees([]);
//       }
...
//       enrollee.FullName.toLowerCase().includes(value.toLowerCase()) ||
//       (enrollee.EnrolleeID && enrollee.EnrolleeID.toLowerCase().includes(value.toLowerCase()))
//     ).slice(0, 10);
...
//     }));
//     setEnrolleeSearchTerm(`${enrollee.FullName} (${enrollee.EnrolleeID || 'No ID'})`);
//     setShowEnrolleeSuggestions(false);
//   };
...
//         ApprovalAmount: formData.approvalRequestAmount ?
//           parseFloat(formData.approvalRequestAmount.replace(/,/g, '')) : 0,
...
//       const newTask = {
//         Department: user.group_name,
//         Title: formData.hospitalName || "N/A",
//         Description: formData.reasonForExclusion || "N/A",
//         startDate: new Date().toISOString().split("T")[0],
//         approvalAmount: formData.approvalRequestAmount ?
//           formData.approvalRequestAmount.replace(/,/g, '') : "0",
//         status: "Pending",
//         mainApprover: formData.mainApprover,
...
//           addTask(newTask);
//         } catch (err) {
//           console.warn("Could not add task to parent component:", err);
//         }
//       }
...
//               {isLoadingProviders ? (
//                 <div className="p-3 text-gray-500">Loading providers...</div>
...
//                   >
//                     <div className="font-medium">{provider.FullName.trim()}</div>
//                     <div className="text-sm text-gray-600 flex justify-between flex-wrap">
//                       <span>Code: {provider.ProviderCode}</span>
...
//                 <span className="ml-2 font-medium text-gray-800">{formData.providerCode}</span>
//               </div>
//               <div>
...
//               Enrollee Name <span className="text-red-500">*</span>
//             </label>
//             <input
//               id="enrolleeName"
//               type="text"
...
//                     >
//                       <div className="font-medium">{enrollee.FullName}</div>
//                       {enrollee.EnrolleeID && (
...
//                   ))
//                 ) : (
//                   <div className="p-3 text-gray-500">{!allEnrollees.length && formData.groupId ? 'Loading/No enrollees for this group' : 'No matching enrollees found'}</div>
//                 )}
//               </div>
//             )}
//           </div>
...
//                 <span className="ml-2 font-medium text-gray-800">{formData.enrolleeId}</span>
//               </div>
//             </div>
//           </div>
//         )}
...
//         {formData.mainApprover && (
//           <div className="bg-yellow-50 p-4 rounded-md border border-yellow-200">
//             <h4 className="text-md font-semibold text-gray-700 mb-2">Approver Assignment</h4>
//             <div className="text-sm">
//               <div className="mb-1">
//                 <span className="text-gray-600">Main Approver:</span>
//                 <span className="ml-2 font-medium text-gray-800">{formData.mainApprover}</span>
//               </div>
//             </div>
//           </div>
//         )}
...
//             className={`w-full py-3 px-4 border border-transparent rounded-md shadow-sm text-lg font-medium text-white ${isSubmitting ? 'bg-blue-700' : 'bg-blue-950 hover:bg-red-600'} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500`}
//           >
//             {isSubmitting ? (
//               <>
